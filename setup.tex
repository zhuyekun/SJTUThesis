...
\sjtusetup{
  ...
  info = {%
      ...
      % 标题
      %
      zh / title           = {稳态辐射输运方程的神经算子方法},
      en / title           = {Neural Operator Methods for Steady-State Radiative Transport Equations},
      %
      % 标题页标题
      %   可使用“\\”命令手动控制换行
      %
      ...
      % 关键词
      %
      zh / keywords        = {深度学习, 辐射输运方程, 格林函数, 注意力机制, 预训练, 自编码器},
      en / keywords        = {deep learning, radiative transport equation, Green's function, attention mechanism, pretraining, autoencoder},
      %
      % 姓名
      %
      zh / author          = {竺烨锟},
